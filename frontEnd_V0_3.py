...
def MainScreen(tab, root):
    ...
    def submitAddCart():
        ...
        c.execute("SELECT unitListPrice FROM products p INNER JOIN vendorPrices vP on p.SKU = vP.SKU WHERE p.SKU = ?",
                  (mycart[0],))
        ...
        try:
            c.execute(
                "INSERT INTO cart VALUES (:SKU, :prodDesc, :productURL, :unitsInStock, :Quantity, :unitPrice, :totalPrice )",
                {
                    'SKU': mycart[0],
                    'prodDesc': mycart[1],
                    'productURL': mycart[2],
    ...
    def DisplayCartWindowPopUp():
        ...
        new_element_header = ["SKU", "Prod Description", "Product URL", "Units In Stock", "Quantity", "unitPrice",
                              "Total"]
    ...
    def deleteConfirm():  # need to MODIFY values in column when table content changes!!!!
        try:
            ...
            print(selectColumn)
            confirm_message = Label(deleteConfirmWindow, text="Are you sure you want to delete selected column?",
                                    padx=10, pady=10)
            confirm_message.grid(row=0, column=0, pady=10)
    ...
    def displayProductsWindowSetUp():
        ...
        display_Products_ContentTree = ttk.Treeview(productFrame, column=("c1", "c2", "c3", "c4", "c5", "c6", "c7"),
    ...
    def displayVendorsWindowSetUp():
        ...
        display_Vendors_ContentTree = ttk.Treeview(vendorFrame, column=("c1", "c2", "c3", "c4", "c5", "c6", "c7", "c8"),
                                                   show='headings', height=15, yscrollcommand=scrollBar.set)
    ...
    def displayOrdersWindowSetUp():
        ...
        display_Orders_ContentTree = ttk.Treeview(orderFrame, column=("c1", "c2", "c3", "c4", "c5"), show='headings',
    ...
    def displayVendorPricesWindowSetUp():
        ...
        display_VendorPrices_ContentTree = ttk.Treeview(vendorPricesFrame, column=("c1", "c2", "c3", "c4"), show='headings',
                                                        height=15, yscrollcommand=scrollBar.set)
    ...
    def displayMainPageQueryWindowSetUp():
        ...
        mainPageQuery_ContentTree = ttk.Treeview(mainpageFrame, column=("c1", "c2", "c3", "c4", "c5"), show='headings', height=15,
    ...
    main_edit_button = Button(mainOptionFrame, text="Edit selected Column", command=editCommand, bg='light gray',
                              fg='black')
    main_edit_button.grid(row=5, column=0, columnspan=2, pady=10, padx=1, ipadx=62)

    # Delete button in Main Screen
    main_delete_button = Button(mainOptionFrame, text="Delete Selected Column", command=deleteConfirm, bg='light gray',
                                fg='black')
    ...
    check_active_orders_button = Button(mainOptionFrame, text="Active Orders", command=queryActiveOrders,
    ...
    add_cart_button = Button(mainOptionFrame, text="Show Cart", command=DisplayCartWindowPopUp, bg='light gray',
                             fg='black')
